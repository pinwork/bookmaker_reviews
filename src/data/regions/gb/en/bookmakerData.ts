...
export const gbBookmakerData: Record<string, RegionalBookmakerData> = {
  ...
  'unibet': {
    ...
    affiliateLink: 'https://www.unibet.co.uk/registration?btag=a_6890b_1c_',
    promotionsPage: 'https://www.unibet.co.uk/promotions',
    payments: ['debit-cards', 'paypal', 'apple-pay', 'skrill', 'neteller', 'trustly', 'bank-transfer'],
    license: '38922 (UKGC)'
  },
  'betvictor': {
    website: 'https://www.betvictor.com',
    affiliateLink: 'https://www.betvictor.com/en-gb/sports?affiliate=1234',
    promotionsPage: 'https://www.betvictor.com/en-gb/offers',
    payments: ['debit-cards', 'paypal', 'apple-pay', 'bank-transfer'],
    license: '39576 (UKGC)'
  },
  'boylesports': {
  ...
  'virgin-bet': {
    website: 'https://www.virginbet.com',
  ...
  'betway': {
    ...
    affiliateLink: 'https://www.betway.com/en-gb/sports?s=bw182393',
    promotionsPage: '',
    payments: ['debit-cards', 'paypal', 'apple-pay', 'bank-transfer'],
    license: '39372 (UKGC)'
  },
  ...
  'netbet': {
    website: 'https://www.netbet.co.uk',
    affiliateLink: 'https://www.netbet.co.uk/sport?btag=a_6890b_1c_',
    promotionsPage: 'https://sport.netbet.co.uk/promotions/',
  ...
  'coral': {
    ...
    affiliateLink: 'https://sports.coral.co.uk/lp/bet-5-get-20?affiliate=1234',
    promotionsPage: 'https://sports.coral.co.uk/promotions',
    payments: ['debit-cards', 'paypal', 'apple-pay', 'paysafecard', 'bank-transfer'],
    license: '39071 (UKGC)'
  },
  'ladbrokes': {
    website: 'https://www.ladbrokes.com',
    affiliateLink: 'https://sports.ladbrokes.com/lp/bet-5-get-20?affiliate=1234',
    promotionsPage: 'https://sports.ladbrokes.com/promotions',
    payments: ['debit-cards', 'paypal', 'apple-pay', 'paysafecard', 'bank-transfer'],
    license: '39071 (UKGC)'
  },
  'bwin': {
