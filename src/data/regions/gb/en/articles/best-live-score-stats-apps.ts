...
export const liveScoreAppsGuide: IndustryReport = {
  ...
  externalLinks: [
    { id: 'flashscore', name: 'Flashscore', url: 'https://www.flashscore.com' },
    ...
    { id: 'footystats', name: 'FootyStats', url: 'https://footystats.org' },
    { id: 'racing-post', name: 'Racing Post', url: 'https://www.racingpost.com' },
    { id: 'timeform', name: 'Timeform', url: 'https://www.timeform.com' },
