...
function getCompetitionArticlesData(region: string): CompetitionArticle[] {
  ...
  const universalArticles: CompetitionArticle[] = [
    // Football
    enCompetitions.footballPremierLeagueBettingGuide,
    enCompetitions.footballChampionsLeagueBettingGuide,
    enCompetitions.footballLaLigaBettingGuide,
    enCompetitions.footballBundesligaBettingGuide,
    enCompetitions.footballSerieABettingGuide,
    enCompetitions.footballLigue1BettingGuide,
    enCompetitions.footballFaCupBettingGuide,
    enCompetitions.footballWorldCupBettingGuide,
    enCompetitions.footballEurosBettingGuide,
    // Tennis
    enCompetitions.tennisWimbledonBettingGuide,
    enCompetitions.tennisAustralianOpenBettingGuide,
    enCompetitions.tennisFrenchOpenBettingGuide,
    enCompetitions.tennisUsOpenBettingGuide,
    // Horse Racing
    enCompetitions.horseRacingCheltenhamFestivalBettingGuide,
    enCompetitions.horseRacingGrandNationalBettingGuide,
    enCompetitions.horseRacingRoyalAscotBettingGuide,
    enCompetitions.horseRacingEpsomDerbyBettingGuide,
    enCompetitions.horseRacingKentuckyDerbyBettingGuide,
    // Golf
    enCompetitions.golfTheMastersBettingGuide,
    enCompetitions.golfTheOpenBettingGuide,
    enCompetitions.golfPgaChampionshipBettingGuide,
    enCompetitions.golfUsOpenBettingGuide,
    enCompetitions.golfRyderCupBettingGuide,
    // Cricket
    enCompetitions.cricketTheAshesBettingGuide,
    enCompetitions.cricketWorldCupBettingGuide,
    enCompetitions.cricketT20WorldCupBettingGuide,
    enCompetitions.cricketIplBettingGuide,
    // American Football
    enCompetitions.americanFootballNflBettingGuide,
    enCompetitions.americanFootballSuperBowlBettingGuide,
    // Basketball
    enCompetitions.basketballNbaBettingGuide,
    enCompetitions.basketballNbaFinalsBettingGuide,
    enCompetitions.basketballMarchMadnessBettingGuide,
    enCompetitions.basketballEuroleagueBettingGuide,
    // Rugby
    enCompetitions.rugbySixNationsBettingGuide,
    enCompetitions.rugbyWorldCupBettingGuide,
    // Darts
    enCompetitions.dartsPdcWorldChampionshipBettingGuide,
    enCompetitions.dartsPremierLeagueBettingGuide,
    // Snooker
    enCompetitions.snookerWorldChampionshipBettingGuide,
    enCompetitions.snookerMastersBettingGuide,
    enCompetitions.snookerUkChampionshipBettingGuide,
    // Boxing
    enCompetitions.boxingHeavyweightBettingGuide,
    // Baseball
    enCompetitions.baseballMlbBettingGuide,
    enCompetitions.baseballWorldSeriesBettingGuide,
    // Ice Hockey
    enCompetitions.iceHockeyNhlBettingGuide,
    enCompetitions.iceHockeyStanleyCupBettingGuide,
    // Formula 1
    enCompetitions.formula1WorldChampionshipBettingGuide,
    // MMA
    enCompetitions.mmaUfcBettingGuide,
    // Esports
    enCompetitions.esportsLeagueOfLegendsWorldsBettingGuide,
    enCompetitions.esportsCs2MajorBettingGuide,
    enCompetitions.esportsTheInternationalBettingGuide,
    enCompetitions.esportsValorantChampionsBettingGuide,
  ];
